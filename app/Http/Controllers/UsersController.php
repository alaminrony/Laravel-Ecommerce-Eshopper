...
class UsersController extends Controller
{
    ...
    public function userLoginRegister(){
      $meta_title="User Login/Register | E-shop";
      $meta_description="User Login/Register of e-shopper website";
      $meta_keywords="User Login/Register, e-shop";
    ...
    public function forgotPassword(Request $request){
      if($request->isMethod('post')){
        ...
        //Send Forget Password into Email
        $email = $data['email'];
        ...
        Mail::send('emails.forgotPassword',$messageData,
        function($message)use($email){
          $message->to($email)->subject('New Password - E-Shopper');
        });
