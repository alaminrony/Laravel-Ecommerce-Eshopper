...
$(document).ready(function(){
	...
	$("#selSize").change(function(){
        ...
        var arr1 =arr[0].split('-');
				$("#getPrice").html("$ "+arr1[0]+"<br><h2>TK "+arr1[1]+"<br>EUR "+arr1[2]+"<br>GBP "+arr1[3]);
				$("#price").val(arr[0]);
				if(arr[1]==0){
					$("#cartButton").hide();
...
function checkPincode(){
  ...
  if(pincode == ''){
    alert("Please Enter Country Code"); return false;
  }
  $.ajax({
       type:'post',
       ...
       success:function(resp){
         if(resp>0){
            $("#pincodeResponse").html("<font color='green'>This Country is available for delivery</font>");
         }else{
            $("#pincodeResponse").html("<font color='red'>This Country is not available for delivery</font>");
         }
