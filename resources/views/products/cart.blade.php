				...
				<div class="total_area">
					<ul>
						@if(!empty(Session::get('CouponAmount')))
							...
							?>
							<li>Grand Total <span class="btn-secondary" data-toggle="tooltip" data-html="true" title="TK {{$getCurrencyRates['BD_Rate']}}<br>
							EUR {{$getCurrencyRates['EUR_Rate']}}<br>
							GBP {{$getCurrencyRates['GBP_Rate']}}">$ <?php echo $total_amount; ?></span></li>
						@else
						   <?php
							     $getCurrencyRates = Product::getCurrencyRates($total_amount);
							 ?>
