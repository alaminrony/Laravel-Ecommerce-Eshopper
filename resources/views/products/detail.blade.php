								...
								<div class="product-information"><!--/product-information-->
									...
									<span>
										...
										<span id="getPrice">
											...
											<h2>
												TK {{$getCurrencyRates['BD_Rate']}}<br>
									...
									<p><b>Delivery:</b>
										<input type="text" name="pincode" id="chkPincode" placeholder="Check Country Code">
										<button type="button" onclick="return checkPincode();">GO</button>
                     <span id="pincodeResponse"></span>
									</p>

								<div style="padding-top:10px;" class="sharethis-inline-share-buttons"></div>
