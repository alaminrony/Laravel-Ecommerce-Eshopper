...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span></span>CMS Pages <span class="label label-important">2</span></a>
   ...
   <li class="submenu"><a href="#"><i class="icon icon-th-list"></i> <span></span>Contact Msg <span class="label label-important">1</span></a>
    <ul <?php if (preg_match("/contact-message/i", $url)){ ?> style="display: block;" <?php } ?>>
      <li <?php if (preg_match("/view-contacts/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/view-contacts')}}">View Message</a></li>
    </ul>
  </li>

  <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span></span>Currencies<span class="label label-important">2</span></a>
