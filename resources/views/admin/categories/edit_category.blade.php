          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('admin/edit-category/'.$categoryDetails->id) }}" name="add_category" id="add_category" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="meta_title" value="{{ $categoryDetails->meta_title }}">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="meta_description" value="{{ $categoryDetails->meta_description }}">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="meta_keywords" value="{{ $categoryDetails->meta_keywords }}">
                </div>
              </div>
