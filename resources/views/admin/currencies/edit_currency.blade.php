      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('/admin/edit-currency/'.$currencyDetails->id) }}" name="edit_currancy" id="edit-currancy" novalidate="novalidate">{{ csrf_field() }}
              <div class="control-group">
                <label class="control-label">Currancy Code</label>
                <div class="controls">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="checkbox" name="status" @if($currencyDetails->status == 1) checked @endif id="status" value="1">
                </div>
              </div>
