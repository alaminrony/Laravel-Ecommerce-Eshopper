          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit-cms-page/'.$cmsPage->id)}}" name="edit_cms_page" id="edit_cms_page" novalidate="novalidate">{{ csrf_field() }}
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="title" value="{{$cmsPage->title}}">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="url" value="{{$cmsPage->url}}">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="meta_title" value="{{$cmsPage->meta_title}}">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="meta_description" value="{{$cmsPage->meta_description}}">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="meta_keywords" value="{{$cmsPage->meta_keywords}}">
                </div>
              </div>
