              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a href="{{ url('/admin/delete-cms-page/'.$page->id) }}" onclick="return confirm('Are you sure you want to delete')" class="btn btn-danger btn-mini">Delete</a>
                        ...
                        <div id="myModal{{ $page->id }}" class="modal hide">
                          ...
                          <div class="modal-body">
                            ...
                            <p><strong>Created on:</strong> {{date("d-m-y",strtotime($page->created_at))}}</p>
